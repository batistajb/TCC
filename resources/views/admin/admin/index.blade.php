        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-6">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="chart">
                            <canvas id="areaChart" style="height:350px" class="pie-chart"></canvas>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var lineChart = new Chart(ctx, {
                    type: 'pie',
                    data: {
                        labels: ["Aprovados", "Reprovados", "Em curso"],
                        datasets:
                            [{
                                data: [success,failure,coursing],
                    ...
                    options: {
                        title: {
                            display: true,
                            fontSize: 20,
                            text: "Relação de alunos por desempenho"
                        },
                        labels: {
                            fontStyle: "bold"
                        }
